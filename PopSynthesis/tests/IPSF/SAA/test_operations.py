...
def test_init_syn_pop():
    ...
    segmented_marg = {}
    zones = hh_marg[hh_marg.columns[hh_marg.columns.get_level_values(0)==zone_field]].values
    ...
    results_run = init_syn_pop_saa("hhsize", segmented_marg["hhsize"], pl.from_pandas(hh_sample))
    for zone in zones:
