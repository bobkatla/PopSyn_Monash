...
def get_hh_census_sa1():
    gdf_vel = gpd.read_file("../../../Generator_data/data/source2/CENSUS/G34_VIC_GDA2020.gpkg", layer="G34_SA1_2021_VIC")
    gdf_num_pp = gpd.read_file("../../../Generator_data/data/source2/CENSUS/G35_VIC_GDA2020.gpkg", layer="G35_SA1_2021_VIC")
    final_df = gdf_vel.merge(gdf_num_pp, how="inner")
...
def get_hh_seed_sa1(atts=None):
    ...
    df_hh = pd.read_csv("../../../Generator_data/data/source/VISTA_1220_SA1_v3/H_VISTA_1220_SA1.csv")
    # df_pp = pd.read_csv("../../../Generator_data/data/source2/VISTA/H_VISTA_1220_LGA_V1.csv")
