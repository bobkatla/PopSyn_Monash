...
from PopSynthesis.Methods.IPSF.utils.ILP_matrix_ad import convert_to_required_ILP_format, convert_back_to_syn_count, update_count_tables

from typing import List, Dict

def convert_to_ILP_inputs(syn_count: pl.DataFrame, att:str, adjusted_atts: List[str], pool_count: pl.DataFrame) -> pl.DataFrame:
